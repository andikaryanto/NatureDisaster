            ...
            <div class="col-lg-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form method = "post" action = "<?php echo base_url('mcity/addsave');?>">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input readonly id = "provincename" placeholder="<?php echo $resource['res_province']?>" type="text" class="form-control"  value="<?php echo $model['provincename']?>">
                        <div class="input-group-append">
                          <button id="btnProvinceModal" data-toggle="modal" type="button" class="btn btn-primary" onclick="getModalProvince(1);" data-target="#modalProvince"><i class="fa fa-search"></i></button>
                        </div>
                      </div>
                    </div>
                    <div class="form-group">       
...
<!-- modal -->
<div id="modalProvince" tabindex="-1" role="dialog" aria-labelledby="modalProvinceLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 id="modalProvinceLabel" class="modal-title">Province</h5>

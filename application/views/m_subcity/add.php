            ...
            <div class="col-lg-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form method = "post" action = "<?php echo base_url('msubcity/addsave');?>">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input readonly id = "cityname" placeholder="<?php echo $resource['res_city']?>" type="text" class="form-control"  value="<?php echo $model['cityname']?>">
                        <div class="input-group-append">
                          <button id="btnCityModal" data-toggle="modal" type="button" class="btn btn-primary" onclick="getModalCity(1);" data-target="#modalCity"><i class="fa fa-search"></i></button>
                        </div>
                      </div>
                    </div>
                    <div class="form-group">       
...
<!-- modal -->
<div id="modalCity" tabindex="-1" role="dialog" aria-labelledby="modalCityLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 id="modalCityLabel" class="modal-title">City</h5>

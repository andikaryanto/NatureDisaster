              ...
              <div id = "cardtabel" class="card">
                <div class="card-header ">
									<div class="row">
										...
										<div class = "col-lg-2 icon-custom-table-header"><a href="<?php echo base_url('ggroupuser/add');?>"><i class="fa fa-plus"></i> <?php echo $resource['res_add']?></a></div>
									</div>
								</div>
                <div class="card-body">
											...
											?>
													<tr>
														...
														<td class = "icon-custom-table-header">
															<a class = "icon-custom-table-detail" href="<?php echo base_url('ggroupuser/edit/').$value->Id;?>"><i class="fa fa-edit"></i><?php echo  $resource['res_edit']?></a>
															...
															<a class = "icon-custom-table-detail" href="<?php echo base_url('ggroupuser/editrole/').$value->Id;?>"><i class="fa fa-user"></i><?php echo  $resource['res_role']?></a>
														</td>
													</tr>
											<?php
												}
                    ...
                    <div class = "col-lg-6 ">
                      <nav aria-label="Page navigation example ">
                        <ul class="pagination">
                          ...
                          ?>
                          <li class="page-item">
                            <a class="page-link" href="<?php echo base_url('g_groupuser');?>?page=<?php echo $currentpage-1?>&search=<?php echo $search?>#cardtabel" aria-label="Previous">
                          ...
                          ?>
                          <li class="page-item">
                            <a class="page-link" href="<?php echo base_url('g_groupuser');?>?page=<?php echo $i?>&search=<?php echo $search?>#cardtabel"><?php echo $i?></a>
                          </li>
                          <?php
                          }
                          ?>
                          ...
                          ?>
                          <li class="page-item">
                            <a class="page-link" href="<?php echo base_url('g_groupuser');?>?page=<?php echo $currentpage+1?>&search=<?php echo $search?>#cardtabel" aria-label="Next">
...
<script type = "text/javascript">
  ...
  function delete_disaster(id, name){
    ...
    if (r==true)
      window.location = "<?php echo base_url('ggroupuser/delete/');?>" + id;
    else
      return false;
  } 
</script>

            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header">
                    ...
                    <div class = "col-lg-2 icon-custom-table-header"><a href="<?php echo base_url('mdisaster');?>"><i class="fa fa-table"></i> Index</a></div>
                  </div>
                </div>
                <div class="card-body">
                  ...
                  ?>
                  <form method = "post" action = "<?php echo base_url('mdisaster/editsave');?>">

                    <input id="iddisaster" hidden = "true" name="iddisaster" value="<?php echo $model['id']?>"/> 

...
class Mprovince_model extends CI_Model {
    ...
    {
        $this->db->insert('m_province', $data);
    }

    public function edit_data($data)
    {
        $this->db->where('Id', $data['id']);
        $this->db->update('m_province', $data);
    }

    public function delete_data($id)
    {
        $this->db->where('Id', $id);
        $this->db->delete('m_province');
    }
    ...
    {
        $resource['res_master_province'] = $this->lang->line('ui_master_province');

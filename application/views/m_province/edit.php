            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header">
                    ...
                    <div class = "col-lg-2 icon-custom-table-header"><a href="<?php echo base_url('mprovince');?>"><i class="fa fa-table"></i> Index</a></div>
                  </div>
                </div>
                <div class="card-body">
                  ...
                  ?>
                  <form method = "post" action = "<?php echo base_url('mprovince/editsave');?>">

                    <input id="idprovince" hidden = "true" name="idprovince" value="<?php echo $model['id']?>"/> 

...
class Manimal_model extends CI_Model {
    ...
    {
        $this->db->insert('m_animal', $data);
    }

    public function edit_data($data)
    {
        $this->db->where('Id', $data['id']);
        $this->db->update('m_animal', $data);
    }

    public function delete_data($id)
    {
        $this->db->where('Id', $id);
        $this->db->delete('m_animal');
    }
    ...
    {
        $resource['res_master_animal'] = $this->lang->line('ui_master_animal');

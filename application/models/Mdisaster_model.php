...
class Mdisaster_model extends CI_Model {
    public $id;
    public $name;
    public $description;
    public $ion;
    ...
    {
        $this->db->insert('m_disaster', $data);
    }

    public function edit_data($data)
    {
        $this->db->where('Id', $data['id']);
        $this->db->update('m_disaster', $data);
    }

    public function delete_data($id)
    {
        $this->db->where('Id', $id);
        $this->db->delete('m_disaster');
    }
    ...
    {
        $resource['res_master_disaster'] = $this->lang->line('ui_master_disaster');

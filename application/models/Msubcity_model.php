...
class Msubcity_model extends CI_Model {
    ...
    {
        $this->db->where('Id', $id);
        $this->db->delete('m_subcity');
    }

    public function create_object_tabel($id, $cityid, $name, $description, $ion, $iby, $uon, $uby)
    {
        $data = array(
            'id' => $id,
            'cityid' => $cityid,
    ...
    public function create_object($id, $cityid, $cityname, $name, $description, $ion, $iby, $uon, $uby)
    {
        $data = array(
            'id' => $id,
            'cityid' => $cityid,

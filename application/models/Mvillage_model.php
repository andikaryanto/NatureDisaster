...
class Mvillage_model extends CI_Model {
    ...
    {
        $this->db->where('Id', $id);
        $this->db->delete('m_village');
    }

    public function create_object_tabel($id, $subcityid, $name, $description, $ion, $iby, $uon, $uby)
    {
        $data = array(
            'id' => $id,
            'subcityid' => $subcityid,
    ...
    public function create_object($id, $subcityid, $subcityname, $name, $description, $ion, $iby, $uon, $uby)
    {
        $data = array(
            'id' => $id,
            'subcityid' => $subcityid,
